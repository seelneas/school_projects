...
using namespace std;
int main() {
    string def_program = "This program takes a degree from 0 - 999 and return the closest degree that doesn't have 1,4 & 7 in its digit";
    cout<<def_program<<"\n\n";
    cout<<"Consider this as a replica of your oven: "<<endl;
    cout<<"1 \t2 \t3 \n4 \t5 \t6 \n7 \t8 \t9 \n \t0"<<endl;
    program:
   int temperature;
